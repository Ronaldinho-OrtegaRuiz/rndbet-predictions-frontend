...
const placeholderClass: Record<RemoteTeamLogoVariant, string> = {
...
/**
 * Muestra `logoUrl` remoto; si falta o falla la carga, el mismo hueco con el placeholder habitual.
 */
export function RemoteTeamLogo({
  ...
  if (!src || failed) {
    return (
      <span
        className={placeholderClass[variant]}
        aria-hidden
        title={label}
      />
    );
