...
} from "../mocks/serieAPredictionsMock";
...
function Stat({
  ...
  return (
    <div className="flex flex-col gap-0.5 rounded-lg border border-white/[0.06] bg-[#0f2440]/50 px-3 py-2">
...
function PredictionCard({ row }: { row: PredictionCardMock }) {
  ...
  return (
    <article className="rounded-2xl border border-white/[0.08] bg-[#15365a] p-4 shadow-[0_6px_24px_rgba(0,0,0,0.18)] sm:p-5">
      <div className="mb-4 border-b border-white/[0.06] pb-3">
        <div className="mb-3 flex flex-wrap items-center justify-end gap-2">
          <span
            ...
            style={{
              backgroundColor: isLive ? `${serieAAccent}22` : "rgba(255,255,255,0.08)",
              color: isLive ? serieAAccent : "rgba(255,255,255,0.75)",
            }}
          >
...
export function SerieAPredictionsPanel() {
  return (
    <div className="space-y-8">
      <div className="space-y-3 rounded-2xl border border-white/[0.08] bg-[#15365a]/60 p-4 sm:p-6">
