...
function Timeline({ events, homeTeam, awayTeam }: { events: MatchEventMock[]; homeTeam: string; awayTeam: string }) {
  ...
  if (sorted.length === 0) {
    return (
      <div
        className="rounded-2xl border p-4 text-sm text-slate-400 sm:p-5"
        style={{ borderColor: LIGUE1_BORDER, backgroundColor: LIGUE1_BG_SURFACE }}
      >
    ...
    >
      ...
      <div className="relative pl-8">
        <span
          ...
          style={{ backgroundColor: LIGUE1_BORDER }}
          aria-hidden
        />
          ...
          return (
            <li key={ev.id} className="relative pb-6 last:pb-0">
              <span
                ...
                style={{
                  borderColor: LIGUE1_BG_SURFACE,
                  backgroundColor:
                    ev.side === "home" ? `${ligue1AccentBlue}55` : `${ligue1AccentPink}50`,
                }}
                aria-hidden
              />
      ...
      {STAT_ROWS.map(({ key, label, format }) => {
        ...
        return (
          <div
            ...
            style={{ borderColor: LIGUE1_BORDER, backgroundColor: LIGUE1_BG_DEEP }}
          >
            <div className="flex flex-col items-end gap-1">
              ...
              >
                <div
                  ...
                  style={{ width: `${hw}%`, backgroundColor: ligue1AccentBlue }}
                />
              </div>
            </div>
            ...
            <div className="flex flex-col items-start gap-1">
              ...
              >
                <div
                  className="h-full rounded-full transition-all"
                  style={{ width: `${aw}%`, backgroundColor: ligue1AccentPink }}
                />
              </div>
            </div>
          </div>
...
function PredictionBlock({
  ...
  const boxStyle = { borderColor: LIGUE1_BORDER, backgroundColor: LIGUE1_BG_DEEP };
  return (
...
export function Ligue1MatchDetailView({ detail }: { detail: MatchDetailMock }) {
  ...
  const top =
    status === "live" ? (
      <div className="flex items-center justify-center gap-2 text-sm font-semibold sm:text-base">
        <span style={{ color: ligue1AccentBlue }}>En vivo</span>
  ...
  const cardStyle = { borderColor: LIGUE1_BORDER, backgroundColor: LIGUE1_BG_SURFACE };
          ...
          <div className="rounded-2xl border p-4 shadow-sm sm:p-6" style={cardStyle}>
            <div className="mb-5 flex flex-wrap items-center justify-center gap-2 sm:justify-start">
              ...
              >
                <button
                  ...
                  style={
                    sideTab === "stats"
                      ? { backgroundColor: ligue1AccentBlue }
            ...
            {sideTab === "stats" ? (
              <>
                ...
                <footer
                  className="mt-6 rounded-xl border border-dashed p-4 text-sm leading-relaxed text-slate-400"
                  style={{ borderColor: LIGUE1_BORDER, backgroundColor: LIGUE1_BG_DEEP }}
                >
