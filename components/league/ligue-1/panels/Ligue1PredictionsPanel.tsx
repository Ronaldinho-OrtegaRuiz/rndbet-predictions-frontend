...
} from "../mocks/ligue1PredictionsMock";
...
function PredictionCard({ row }: { row: PredictionCardMock }) {
  ...
  return (
    ...
    >
      <div className="mb-4 border-b pb-3" style={{ borderColor: LIGUE1_BORDER }}>
        <div className="mb-3 flex flex-wrap items-center justify-end gap-2">
          <span
            className="shrink-0 rounded-full px-3 py-1 text-xs font-bold sm:text-sm"
            style={{
              backgroundColor: isLive ? `${ligue1AccentBlue}28` : "rgba(255,255,255,0.06)",
              color: isLive ? ligue1AccentBlue : "rgba(226, 232, 240, 0.85)",
            }}
          >
...
export function Ligue1PredictionsPanel() {
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-sm leading-relaxed text-slate-400 sm:text-base">
          ...
          <strong style={{ color: ligue1AccentBlue }}>en vivo</strong>: los partidos{" "}
