...
function Timeline({ events, homeTeam, awayTeam }: { events: MatchEventMock[]; homeTeam: string; awayTeam: string }) {
  ...
  if (sorted.length === 0) {
    return (
      <div className="rounded-2xl border border-white/[0.08] bg-[#15365a]/80 p-4 text-sm text-white/55 sm:p-5">
  ...
  return (
    <div className="rounded-2xl border border-white/[0.08] bg-[#15365a]/80 p-4 sm:p-5">
        ...
        {sorted.map((ev) => {
          ...
          return (
            <li key={ev.id} className="relative pb-6 last:pb-0">
              <span
                className="absolute left-0 top-1.5 flex size-5 items-center justify-center rounded-full border-2 border-[#15365a] sm:top-2"
                style={{
                  backgroundColor: ev.side === "home" ? `${serieAAccent}55` : "rgba(255,255,255,0.2)",
                }}
                aria-hidden
              />
    ...
    <div className="space-y-1">
      ...
      {STAT_ROWS.map(({ key, label, format }) => {
        ...
        return (
          <div
            key={String(key)}
            className="grid grid-cols-[1fr_auto_1fr] items-center gap-x-2 gap-y-1 rounded-lg border border-white/[0.06] bg-[#0f2440]/40 px-2 py-2 sm:px-3"
          >
            <div className="flex flex-col items-end gap-1">
              ...
              <div className="h-1 w-full max-w-[6rem] overflow-hidden rounded-full bg-white/[0.08]">
                <div
                  ...
                  style={{ width: `${hw}%`, backgroundColor: serieAAccent }}
                />
              </div>
            </div>
    ...
    <div className="space-y-6">
      <section>
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          <div className="rounded-lg border border-white/[0.06] bg-[#0f2440]/40 px-3 py-2">
          ...
          <div className="rounded-lg border border-white/[0.06] bg-[#0f2440]/40 px-3 py-2 sm:col-span-2">
...
export function SerieAMatchDetailView({ detail }: { detail: MatchDetailMock }) {
  ...
  const top =
    status === "live" ? (
      <div className="flex items-center justify-center gap-2 text-sm font-semibold sm:text-base">
        <span style={{ color: serieAAccent }}>En vivo</span>
  ...
  return (
    <div className="space-y-8">
      <article className="rounded-2xl border border-white/[0.08] bg-[#15365a] p-4 shadow-[0_6px_24px_rgba(0,0,0,0.18)] sm:p-6 md:p-8">
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,280px)_1fr] lg:items-start">
        ...
        <div className="order-1 min-w-0 lg:order-2">
          <div className="rounded-2xl border border-white/[0.08] bg-[#15365a]/90 p-4 shadow-[0_6px_24px_rgba(0,0,0,0.18)] sm:p-6">
            <div className="mb-5 flex flex-wrap items-center justify-center gap-2 sm:justify-start">
              ...
              <div className="inline-flex rounded-full border border-white/[0.12] bg-[#0f2440]/60 p-1">
                <button
                  type="button"
                  ...
                  style={
                    sideTab === "stats"
                      ? { backgroundColor: serieAAccent, color: serieAOnAccent }
            ...
            {sideTab === "stats" ? (
              <>
                ...
                <footer className="mt-6 rounded-xl border border-dashed border-white/[0.12] bg-[#0f2440]/30 p-4 text-sm leading-relaxed text-white/60">
