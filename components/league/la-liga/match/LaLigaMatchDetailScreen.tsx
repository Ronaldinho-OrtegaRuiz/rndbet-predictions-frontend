          ...
          <div className="flex min-h-[inherit] min-w-0 flex-1 flex-wrap items-center gap-x-4 gap-y-2 py-2 pr-3 sm:gap-x-6 sm:pr-5">
            <div className="flex h-14 w-14 shrink-0 items-center justify-center sm:h-[4.5rem] sm:w-[4.5rem]">
              ...
              <img
                ...
                height={116}
                draggable={false}
                className="h-auto w-auto max-w-full object-contain object-center max-h-[1.9rem] sm:max-h-[2.45rem]"
              />
            </div>
            <div className="min-w-0">
              <p className="text-xs font-medium text-slate-500 sm:text-sm">Partido</p>
              <h1 className="truncate text-base font-bold text-slate-900 sm:text-lg md:text-xl">
                {detail.homeTeam} <span className="font-normal text-slate-400">vs</span> {detail.awayTeam}
              </h1>
            </div>
          </div>
        </div>
